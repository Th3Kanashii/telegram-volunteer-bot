...
main-menu = Main Menu 📌
back-menu = You've returned to the main menu 🏠

cancel-subscribe = Cancel Subscription ❌
subscription-cancelled = Subscription Cancelled ❌

subscribed = Your words are fire, write to me, crazy! 🤗
volunteer-not-active = Communication with the volunteer is not available 🥲
not-category = Please choose a category 👇
...
new-member = Hello { $name }, and welcome to the Living Library #LivingLibrary!

admin-language = Language successfully set
...
get-db =
        Number of users in the bot - { $users }
        ...
        Legal Support - { $legal_support } ({ $legal_support_percentages }%)

input-time = Enter the time in the format dd.mm/hh:mm 🕒
input-message = Send a message for notification 📬

all = Notification successfully sent ✅
