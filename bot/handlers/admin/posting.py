...
async def process_command_posting(message: Message, i18n: I18nContext, state: FSMContext) -> Any:
    """
...
async def process_command_cancel(message: Message, bot: Bot, state: FSMContext) -> Any:
    """
...
async def process_posting_time(message: Message, i18n: I18nContext, state: FSMContext) -> Any:
    """
